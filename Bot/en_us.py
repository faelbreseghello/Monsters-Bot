...
helpmsg.add_field(name='*pts', value='I\'ll send the points of the mentioned people :)', inline=True)
helpmsg.add_field(name='*trakinas', value='a charity campaing.', inline=False)
helpmsg.add_field(name='*rank', value='The all-time minigame rank.', inline=True)
helpmsg.add_field(name='*cringegif', value='A random trending gif.', inline=False)
